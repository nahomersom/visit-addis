...
export function GuideSubscribeBanner() {
  return (
    <section className="py-10 px-6 md:px-12 lg:px-[120px] rounded-4xl">
          <CallToActionBanner
            title={{
              coloredText: "",
              regularText: "Never Miss a Moment!",
            }}
            className="py-[60px] md:py-10"
            description="Unlock Addis Ababa's best-kept secrets! Subscribe now for a monthly guide to exclusive cultural events,
underground art scenes, and the most exciting happenings around the city."
            overlayColor="#F9F9F9"
            customContent={
