...
const BlogHero = () => {
  return (
    ...
    h-[500px] sm:h-[450px] 
    md:h-auto md:py-[120px] md:px-12
    ...
    " style={{ backgroundImage: `url(${EventHeroPicture})`}}>
        ...
        {/* content */}
        <div className="relative flex flex-col items-center text-center w-full gap-3 
        px-4 md:px-0">
            <h1 className="font-bold text-white text-[28px] sm:text-[36px] md:text-[48px] lg:text-[64px] leading-tight">
                Stories from <span className="text-[#DAA112]">Addis Ababa</span>
            </h1>
