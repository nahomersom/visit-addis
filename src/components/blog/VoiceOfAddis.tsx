...
const VoiceOfAddis: React.FC<VoiceProps> = ({ title = "Voice Of Addis" }) => {
  return (
    ...
    // 1. Single wrapper div (removed nested container).
    // 2. Padding is now px-6 on mobile, jumping to px-[120px] on md screens to match Newsletter.
        ...
        {articles.map((item) => (
          <div 
            ...
            className="flex flex-col justify-between transition-all duration-300 
                       w-full min-h-[272px] h-fit 
                       bg-[#F7F8F7] rounded-2xl p-2 gap-4 
                       md:h-[445px] md:bg-[#7F9276]/6 md:rounded-3xl md:p-4"
          >
            {/* Image */}
