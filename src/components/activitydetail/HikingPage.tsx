      ...
      ">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-[24px] font-bold text-[#10383A]">
              Hiking In Addis Abeba
            </h1>
          </div>
          
          {/* Description */}
          <p className="text-[14px] text-[#758886] leading-relaxed">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[14px] font-bold text-[#10383A]">Locations</span>
          </div>
