  ...
  return (
    ...
    " style={{ backgroundImage: `url(${EventHeroPicture})`}}>
        ...
        <div className="relative flex flex-col items-center text-center w-full gap-3 px-4">
            <h1 className="font-bold text-white text-[28px] sm:text-[36px] md:text-[48px] lg:text-[64px] leading-tight">There’s Always Something Happening in <span className="text-[#DAA112]">Addis Ababa</span></h1>
